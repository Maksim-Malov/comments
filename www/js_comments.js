...
function ajax(param)
{
	...
	if(param.url == "add_categories.php"){
		param.data.categories = prompt('Какую категорию хотите добавить?', '');
	}
	if(param.url == "edit_categories.php"){
		param.data.categories = prompt('Название для изменения.', '');
	}
